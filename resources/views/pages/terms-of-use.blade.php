...
@section('content')
  <main class="home-page container">
    <div style="flex-grow: 1;">
      ...
      <div class="box">
        <p>Настоящее Пользовательское соглашение (далее — «Соглашение») представляет собой предложение пользователю сети Интернет (далее — «Пользователь») заключить соглашение об использовании сервисов (далее — «Сервисы») предусмотренных на сайте lafeum.ru (далее — «Сайт»).</p>
